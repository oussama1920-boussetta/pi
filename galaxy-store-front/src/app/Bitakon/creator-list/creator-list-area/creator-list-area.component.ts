...
@Component({
  selector: 'app-creator-list-area',
  templateUrl: './creator-list-area.component.html',
  styleUrls: ['./creator-list-area.component.scss']
})
export class CreatorListAreaComponent implements OnInit {
