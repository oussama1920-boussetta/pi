...
@Component({
  selector: 'app-live-auction-area',
  templateUrl: './live-auction-area.component.html',
  styleUrls: ['./live-auction-area.component.scss']
})
export class LiveAuctionAreaComponent implements OnInit {
